...
const Navbar = () => {
  ...
  return (
    ...
    <h1 className="text-lg md:text-xl font-extrabold"><Link to="/">Otaku Blogs</Link></h1>
    ...
    <div className="hidden md:flex items-center justify-center space-x-2 md:space-x-4">
      {user? <h3 className="capitalize"><Link to="/profile/:id">{user.username}</Link></h3> :<h3><Link to="/login">Login</Link></h3>}
